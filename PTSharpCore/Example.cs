...
namespace PTSharpCore
{
    class Example
    {
        ...
        public static void Dragon(int width, int height)
        {
            ...
            scene.Add(Sphere.NewSphere(new Vector(-1, 10, 0), 1, light));
        ...
        public static void Runway(int width, int height)
        {
            const int radius = 2;
            const int _height = 3;
            ...
            {
                scene.Add(Sphere.NewSphere(new Vector(-100, (double)y, _height), radius, light));
                scene.Add(Sphere.NewSphere(new Vector(0, (double)y, _height), radius, light));
                scene.Add(Sphere.NewSphere(new Vector(100, (double)y, _height), radius, light));

            }
            for (int y = -40; y >= -750; y -= 20)
            {
                scene.Add(Sphere.NewSphere(new Vector(-10, (double)y, _height), radius, light));
                scene.Add(Sphere.NewSphere(new Vector(0, (double)y, _height), radius, light));
                scene.Add(Sphere.NewSphere(new Vector(10, (double)y, _height), radius, light));
            }
            ...
            {
                scene.Add(Sphere.NewSphere(new Vector((double)x, -20, _height), radius, green));
                scene.Add(Sphere.NewSphere(new Vector((double)x, 6100, _height), radius, red));
            }
            scene.Add(Sphere.NewSphere(new Vector(-160, 250, _height), radius, red));
            scene.Add(Sphere.NewSphere(new Vector(-180, 250, _height), radius, red));
            scene.Add(Sphere.NewSphere(new Vector(-200, 250, _height), radius, light));
            scene.Add(Sphere.NewSphere(new Vector(-220, 250, _height), radius, light));
            for (int i = 0; i < 5; i++)
            {
                ...
                for (int j = 1; j <= 4; j++)
                {
                    ...
                    scene.Add(Sphere.NewSphere(new Vector(x, y, _height), radius, red));
                    scene.Add(Sphere.NewSphere(new Vector(-x, y, _height), radius, red));
                    scene.Add(Sphere.NewSphere(new Vector(x, -y, _height), radius, light));
                    scene.Add(Sphere.NewSphere(new Vector(-x, -y, _height), radius, light));
                }
            }
        ...
        public static void Bunny(int width, int height)
        {
            ...
            scene.Add(mesh);
            var floor = Material.GlossyMaterial(Colour.HexColor(0x8a8b8d), 1.2F, Util.Radians(20));
        ...
        public static void Embree(int width, int height)
        {
            Raytracer rt = new();
            ...
            // Trace a single ray
            TinyEmbree.Hit hit = rt.Trace(new TinyEmbree.Ray
            {
        ...
        public static void Volume(int Width, int Height)
        {
            ...
            var volume = PTSharpCore.Volume.NewVolume(box, bmplist.ToArray(), 3.4F / 0.9765625F, windows.ToArray());
            scene.Add(volume);
        ...
        public static void VeachScene(int Width, int Height)
        {
            Scene scene = new Scene();
            Material material;
            Mesh mesh;
